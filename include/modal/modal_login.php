...
<div class="modal fade" id="modal_login" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header"style="background-image: linear-gradient(to left,#363a75,#b3852f,#eeba3e);">
                ...
                <div class="wrapper fadeInDown" style="box-shadow:none;">
                    <div id="formContent" class="text-center">
                        ...
                        <form action="<?= $_SERVER["PHP_SELF"] ?>" method="POST">
                            ...
                            <input type="submit" class="fadeIn fourth" name="login_submit" value="Logar">
                        </form>
